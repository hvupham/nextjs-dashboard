...
import { createProduct, ProductState } from '@/app/lib/actions/products';
...
export default function Form({ simStatuses }: { simStatuses: SIMStatus[] }) {
  const initialState: ProductState = { message: '', errors: {} };
  const [state, formAction] = useActionState(createProduct, initialState);
  const [simType, setSimType] = useState<'physical' | 'multi' | 'esim'>('multi');
