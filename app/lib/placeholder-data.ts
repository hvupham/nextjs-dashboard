...
const invoices = [
  ...
  },
  {
    ...
    package_months: 6,
    notes: 'Tặng dịch vụ bảo hành mở rộng',
  },
  {
    customer_id: customers[1].id,
    amount: 500,
    ...
    sim_status: 'xuat',
    employee_id: users[2].id,
    export_date: '2023-08-20',
    tracking_number: 'TRK001244',
    package_months: 1,
    notes: 'Gói rẻ nhất',
  },
  {
    ...
    package_months: 8,
    notes: 'Khách hàng yêu cầu hóa đơn điện tử',
  },
  {
    customer_id: customers[2].id,
    amount: 1000,
